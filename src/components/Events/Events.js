...
// import mainEventBanner from "../Assets/MainEventImage.png"; // update filename if different
...
//                 <h3 className="text-2xl font-bold text-[#37378c] mb-3">
//                   {event.title}
//                 </h3>
...
import mainEventBanner from "../../Assets/MainEventImage.png";
...
const Events = () => {
  ...
  return (
    <div className="p-6 max-w-6xl mx-auto">
      ...
      {selectedEvent && (
        <RegisterForm event={selectedEvent} onClose={() => setSelectedEvent(null)} />
      )}
    </div>
  );
};
