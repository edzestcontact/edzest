...
const Footer = () => {
  return (
    <footer className="bg-white dark:bg-gray-900 shadow-md text-gray-700 dark:text-gray-300 py-6 border-t dark:border-gray-700">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-2">
            ...
            <a
              href="mailto:contact@edzest.org"
              className="text-decoration-none text-sm leading-relaxed text-gray-700 dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400"
            >
              contact@edzest.org
            </a>

            <div className="flex items-center mb-3 flex space-x-3">                
              <span className="text-sm leading-relaxed text-gray-700 dark:text-gray-400">+91 9673332684</span>
            </div>
          </div>

          {/* Navigation Links */}
          <div>
            <h4 className="text-lg font-semibold mb-3 text-gray-700 dark:text-gray-300">Company</h4>
            <ul className="space-y-2">
              <li>
                <Link 
                  to="/about" 
                  className="text-gray-700 text-decoration-none dark:text-gray-400 hover:text-blue-500 dark:hover:text-blue-400"
                >
                  About Us
                </Link>
              </li>
          ...
          {/* Help & Support */}
          <div>
            <h4 className="text-lg font-semibold mb-3 text-gray-700 dark:text-gray-300">Help & Support</h4>
            <ul className="space-y-2">
              <li>
                <Link 
                  to="/contact" 
        ...
        <div className="flex justify-end items-center mt-8 border-t pt-4 dark:border-gray-600">
          {/* Social Media Links */}
