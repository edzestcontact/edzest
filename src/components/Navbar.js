...
{/* 
          ...
          <a href="https://exams.edzest.org/learn/account/signin" target="_blank" rel="noopener noreferrer"
          ...
          <div className="position-fixed top-0 pt-4 end-0 h-100 bg-light shadow-lg d-md-none" style={{ width: '80%', maxWidth: '300px', zIndex: 1050 }}>
            ...
            <nav className="p-4">
              ...
              <div className="d-flex flex-column align-items-center" style={{ marginTop: "-18px" }}>
                <button onClick={() => setShowMobileResources(!showMobileResources)} className="text-dark bg-transparent border-0 py-2 w-100 text-center">
                  Resources ▼
                </button>
                {showMobileResources && (
                  <div className="d-flex bg-white flex-column align-items-center w-100">
                    <Link to="/docs" onClick={() => handleNavClick("/docs")} className="text-gray-800 py-2 text-decoration-none hover:text-white hover:bg-[#4748ac]">
                      Project Docs
                    </Link>
                    ...
                    {/* Added Drag & Drop Quiz Link for Mobile */}
                    {/* <Link to="/drag-and-drop" onClick={() => handleNavClick("/drag-and-drop")} className="text-gray-700 text-center py-2 text-decoration-none hover:bg-[#4748ac] hover:text-white">
                      Drag & Drop Quiz
                    </Link> */}
                  </div>
                )}
